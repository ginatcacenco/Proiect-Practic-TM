...
## 3.7  Bugs report
Bugs have been created based on the failed tests.The complete bug reports can be found here:[Emergency contacts bugg.pdf](https://github.com/ginatcacenco/Proiect-Practic-TM/blob/main/bugs.pdf)
